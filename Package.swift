...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_GeoLocation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_GeoLocation-1.3.0-beta.1.xcframework.zip",
			checksum: "cc82e2c839870b8fe6d7623b42c6690405bde18f3e6ed04f2565a2aac2073c22"
		)
	]
)