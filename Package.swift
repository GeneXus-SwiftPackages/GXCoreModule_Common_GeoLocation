...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_GeoLocation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_GeoLocation-1.2.0-beta.36.xcframework.zip",
			checksum: "89c71b0e177382aae7d50a27608edff3d0420463b34803d61181a194facc51eb"
		)
	]
)