...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_GeoLocation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_GeoLocation-2.0.0-beta.18.xcframework.zip",
			checksum: "fb7b6d9e821583c8016345663302cbf4efdbcdbd5265078bdc2d3395d1acd586"
		)
	]
)