...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_GeoLocation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_GeoLocation-1.0.0-beta.20230623154354.xcframework.zip",
			checksum: "2cc438f7525fd1eefedcfe2996e6488f0ab60aa9499925fbc1b4c5942a207571"
		)
	]
)