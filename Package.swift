...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_GeoLocation",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_GeoLocation-2.0.12.xcframework.zip",
			checksum: "25661c1e4d00d5ff6c9849f33172e01824ed0970918cd101248c88d1f1097525"
		)
	]
)