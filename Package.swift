...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_GeoLocation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_GeoLocation-2.1.0-beta.23.xcframework.zip",
			checksum: "10ead11f34ffa2eb2d423f393962d3c903767cd82aeac26d23914ce95d668be3"
		)
	]
)