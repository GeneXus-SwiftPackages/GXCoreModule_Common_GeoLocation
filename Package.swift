...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_GeoLocation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_GeoLocation-1.0.0-beta.20230627202653.xcframework.zip",
			checksum: "8fd5c3b7f1f7e5295b4c37c3c3255ab4f933f0fac1a026d10c2ddb7350cca9b0"
		)
	]
)