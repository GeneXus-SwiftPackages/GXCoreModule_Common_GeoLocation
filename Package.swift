...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_GeoLocation",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_GeoLocation-1.1.0-rc.5.xcframework.zip",
			checksum: "f7d897187938dd766c232d6ceb16e02a45b1bdad07c2c5d3452596d10d4d3315"
		)
	]
)