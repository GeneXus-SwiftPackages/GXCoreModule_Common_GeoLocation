...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_GeoLocation",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_GeoLocation-1.3.6.xcframework.zip",
			checksum: "8c19b8a0faf955f006ff749a4899be96ee02185fd50c0e1a06f839bc1b08a489"
		)
	]
)