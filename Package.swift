...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_GeoLocation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_GeoLocation-1.2.0-beta.37.xcframework.zip",
			checksum: "2025d360d1f91a39778a7250ecdd2ca24b97ac0590d9628dc0f7289ef5d86556"
		)
	]
)