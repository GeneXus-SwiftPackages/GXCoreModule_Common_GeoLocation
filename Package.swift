...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_GeoLocation",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_GeoLocation-1.2.0-rc.29.xcframework.zip",
			checksum: "aa98f4d6968277acc30e741b50923c5a87733816dda8a5cbd32f952f3937fbfe"
		)
	]
)