...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_GeoLocation",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_GeoLocation-1.4.0-rc.1.xcframework.zip",
			checksum: "50aec703965fa6a52d54bd625936a05101751567c6ff0b2b0f33b7a12bee38e2"
		)
	]
)