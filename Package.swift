...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_GeoLocation",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_GeoLocation-1.2.0-rc.36.xcframework.zip",
			checksum: "8f4ffc9c09a5db551d63f7ef88733c1e6e7b09d6c9155d2b8d31d1a2948e9965"
		)
	]
)