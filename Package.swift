...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_GeoLocation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_GeoLocation-1.1.0-beta.9.xcframework.zip",
			checksum: "1960a01c39ebf6052d13c9c351a46633e6c4c23a45ed3666e0e5972557765600"
		)
	]
)