...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_GeoLocation",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_GeoLocation-1.3.0-rc.1.xcframework.zip",
			checksum: "ae9c20e25faf3a1c665975734eb500e2b4f980e137b0ecd9d4d457db67248209"
		)
	]
)