...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_GeoLocation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_GeoLocation-1.3.0-beta.4.xcframework.zip",
			checksum: "81e53e9e1c50af45698da1b9e0caeaf8e5cd3275a17c799fe4673cfde94f988d"
		)
	]
)