...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_GeoLocation",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_GeoLocation-3.2.0.xcframework.zip",
			checksum: "44939e9ff164b391697e5cb133077c345b0c14f6555b117ac59e95af742c1ce4"
		)
	]
)