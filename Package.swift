...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_GeoLocation",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_GeoLocation-3.0.0.xcframework.zip",
			checksum: "521bfd0a3f13ddad2693afa8ce28ce3462cb1d49137bf836f0989699fb4e4677"
		)
	]
)