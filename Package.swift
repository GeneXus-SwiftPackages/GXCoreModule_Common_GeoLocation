...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_GeoLocation",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_GeoLocation-1.1.0-rc.1.xcframework.zip",
			checksum: "4fc64a3cc9cb120f1f54f5c3801054d25e923e61f9d358971c12b6f907f70124"
		)
	]
)