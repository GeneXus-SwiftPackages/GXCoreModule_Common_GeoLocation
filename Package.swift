...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_GeoLocation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_GeoLocation-3.2.0-beta.28.xcframework.zip",
			checksum: "06f0ab8e2467ab5486d1b9f7385b4c9f1ffd2c80f91cb3caee5ca6a05f72ec7c"
		)
	]
)