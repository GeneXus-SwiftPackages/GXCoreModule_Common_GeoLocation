...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_GeoLocation",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_GeoLocation-1.1.2.xcframework.zip",
			checksum: "6758d9f88210628d2c422a4d1ab67426bdbb2da52a016b45b818986918a677ff"
		)
	]
)