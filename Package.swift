...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_GeoLocation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_GeoLocation-1.6.0-beta.1.xcframework.zip",
			checksum: "b9d90ca058fd536a9c2af8c2adeda30ed81b8abdebc6b0bafa66528333289759"
		)
	]
)