...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_GeoLocation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_GeoLocation-2.0.0-beta.41.xcframework.zip",
			checksum: "336125d4c03fbe26bddca92054caee8078a01cc561fc936eeb16feb3d9d480c6"
		)
	]
)