...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_GeoLocation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_GeoLocation-1.0.0-beta.20230726144822.xcframework.zip",
			checksum: "e0f9223ffe7db03a9b8c2c0cd37935f215bd6064b6fbd91953e8a522a8593801"
		)
	]
)