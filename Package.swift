...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_GeoLocation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_GeoLocation-3.2.0-beta.38.xcframework.zip",
			checksum: "d213219accee11baa61aba46f9a115bfdbbd3683ee7f5658e59be2c4ab83977f"
		)
	]
)