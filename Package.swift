...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_GeoLocation",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_GeoLocation-1.1.0-rc.3.xcframework.zip",
			checksum: "2c49041e4d7fdb3a3f9334256b21947d77ebf13d82bd2ebd915f3c3cf1588aed"
		)
	]
)