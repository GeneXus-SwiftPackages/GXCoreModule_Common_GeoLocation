...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_GeoLocation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_GeoLocation-2.0.0-beta.6.xcframework.zip",
			checksum: "311c8b69652bfa9cb950f21c442b79cb2f2200db20ee69d31dda6ded6de9dd68"
		)
	]
)